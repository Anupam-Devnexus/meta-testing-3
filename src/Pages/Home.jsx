  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100">
      ...
      <header className="flex flex-col items-center justify-center text-center py-20 px-4 bg-white shadow-md rounded-b-3xl">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#00357a] mb-4">
        ...
        <button
          ...
          className="bg-[#00357a] hover:bg-indigo-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:scale-105"
        >
          Login
        </button>
      </header>
      ...
      <section className="flex flex-col md:flex-row justify-center items-start md:items-stretch mt-12 px-6 md:px-20 gap-8">
        ...
        <div className="flex-1 bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow text-center">
          <h2 className="text-2xl font-semibold text-[#00357a] mb-3">Facebook Pages</h2>
        ...
        <div className="flex-1 bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow text-center">
          <h2 className="text-2xl font-semibold text-[#00357a] mb-3">Google Calendar</h2>
          <p className="text-gray-600">
      ...
      <section className="flex flex-col items-center my-16 px-6 text-center">
        <h3 className="text-3xl font-semibold text-[#00357a] mb-4">
        ...
        <button
          onClick={() => navigate("/login")}
          className="bg-[#00357a] hover:bg-indigo-700 text-white font-semibold py-3 px-10 rounded-full shadow-lg transition-transform transform hover:scale-105"
        >
          Get Started
        </button>
      </section>
      ...
      <footer className="mt-auto bg-white py-6 px-4 md:px-20 flex flex-col md:flex-row justify-between items-center shadow-inner rounded-t-3xl">
        ...
        <div className="flex gap-6">
          <button
            ...
            className="text-[#00357a] hover:underline"
          >
            Privacy Policy
          </button>
          <button

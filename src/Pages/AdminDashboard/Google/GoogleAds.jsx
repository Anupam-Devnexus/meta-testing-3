...
import { FiFilter, FiCheck, FiPlus } from "react-icons/fi"
...
export default function GoogleAds() {
  ...
  return (
    <section className="w-full bg-gray-50 min-h-screen p-2">
  ...
  <div className="flex flex-wrap gap-3 items-center">
    ...
    <div className="flex items-center gap-2">
      <select
        ...
        className="px-4 py-2 border-b border-gray-300  text-sm  outline-none"
      >
    ...
    {showCustomInput && (
      <div className="flex gap-2 items-center">
        <input
          ...
          className="px-3 py-2 border-b border-gray-300  text-sm outline-none"
        />
        <button
          onClick={addCustomRemark}
          className="flex items-center gap-1 px-2 py-2 cursor-pointer bg-green-600 text-white rounded-full shadow-sm hover:bg-green-700 transition"
        >
          <FiPlus /> 
        </button>
      </div>
    ...
    >
      <FiCheck className="text-lg" /> Apply
    </button>
  </div>
</div>
